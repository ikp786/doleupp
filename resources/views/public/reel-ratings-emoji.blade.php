            ...
            <div class="container">
                <div class="section-title pb-0">
                    ...
                    <div class="rating">
                        ...
                        <label for="rating01"><span class="rating1"><font>😠</font></span></label>
                        <input type="radio" name="rating" id="rating02" value="2"/>
                        <label for="rating02"><span class="rating2"><font>🙁</font></span></label>
                        <input type="radio" name="rating" id="rating03" value="3"/>
                        <label for="rating03"><span class="rating3"><font>😐</font></span></label>
                        <input type="radio" name="rating" id="rating04" value="4"/>
                        <label for="rating04"><span class="rating4"><font>🙂</font></span></label>
                        <input type="radio" name="rating" id="rating05" value="5"/>
                        <label for="rating05"><span class="rating5"><font>😍</font></span></label>
