                ...
                <div class="icon-box">
                    <div class="row">
                        ...
                        <div class="col-md-10 p-5">
                            <div class="text-center"><img src="{{ asset($data->image ?? 'assets/img/profile.png') }}" alt="" width="120"></div>
                            <h3 class="text-center">{{ $data->name ?? '' }}</h3>
                            <p class="mt-2 text-center">{{ $data->about ?? '' }}</p>
                            <div class="cat-p">
                                <p class="grn-col"><img src="{{ asset('assets/img/location.svg') }}" alt="">&nbsp; {{ $data->state ?? '' }} {{ $data->country ?? '' }}</p>
                                ...
                                <p class="grn-col">DoleUpp Send (${{ $data['donation_send'] ?? 0 }})</p>
                                ...
                                <ul class="nav nav-tabs text-center" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="true">Donated to ({{ count($donation_to) ?? 0 }})</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                            data-bs-target="#profile" type="button" role="tab" aria-controls="profile"
                                            aria-selected="false">DoleUpp from ({{ count($donation_from) ?? 0 }})</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        ...
                                        <div class="donrs">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 text-left">
                                                    ...
                                                    <span>Category: {{ $to->donation_request->category->name ?? '' }}  | User: <a href="{{ route('donors', ['username' => $to->donation_to_user->id]) }}">{{ $to->donation_to_user->name ?? '' }}</a></span>
                                                </div>
                                        ...
                                        <div class="donrs">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 text-left">
                                                    ...
                                                    <span>Category: {{ $by->donation_request->category->name ?? '' }} | Video Title: <a href="{{ route('reels.show', ['slug' => $by->donation_request->id]) }}">{{ $by->donation_request->caption ?? '' }}</a></span>
                                                </div>
                                                <div class="col-md-3 text-left">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center px-0">
                    ...
                    <h3>Share {{ $data->name ?? '' }} profile by</h3>
                    <div id="main-icon-div">
                        <div id="social-links2">
                            <ul>
                                <li>
                                    <a href="sms:?&body={{ $data->name.' '.route('donors', ['username' => $data->id]) }}" class="social-button "><span class="fas fa-sms"></span></a>
                                </li>
                                <li>
                                    <a href="mailto:?subject=Share Profile - {{ $data->name ?? '' }}&body={{ $data->name.' '.route('donors', ['username' => $data->id]) }}">
